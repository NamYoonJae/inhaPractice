...
void cTitleScene::Setup()
{
	...
	pButton = new cButton;
	pButton->Setup("data/UI/TitleScene", "버튼 비활성화 사이즈 조정.png", 
		D3DXVECTOR3(rc.right * nRight, rc.bottom * nBottom, 0), 180, 160, 0, 2, true);
	pBackGoundBtnPopup->cButtonPushBack(pButton);
	...
	pButton = new cButton;
	pButton->Setup("data/UI/TitleScene", "버튼 비활성화 사이즈 조정.png", 
		D3DXVECTOR3(rc.right * nRight, rc.bottom * nBottom, 0), 180, 260, 0, 2, true);
	pBackGoundBtnPopup->cButtonPushBack(pButton);
	...
	pButton = new cButton;
	pButton->Setup("data/UI/TitleScene", "버튼 비활성화 사이즈 조정.png", 
		D3DXVECTOR3(rc.right * nRight, rc.bottom * nBottom, 0), 180, 360, 0, 2, true);
	pBackGoundBtnPopup->cButtonPushBack(pButton);
